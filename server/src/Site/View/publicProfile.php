        ...
        <div class="menu-screen">
            ...
            <div class="stats">
                <div class="stats-block stats-block-first">
                    ...
                    <span id="stats-name" class="stats-result">
                ...
                <div class="stats-block">
                    ...
                    <span id="stats-kills" class="stats-result">
                        <?php echo htmlspecialchars($user->getStats()->getKills()) ?>
                    </span>
                </div>

                <div class="stats-block">
                    <p class="stats-text">Смертей:</p>
                    <span id="stats-deaths" class="stats-result">
                        <?php echo htmlspecialchars($user->getStats()->getDeaths()) ?>
                    </span>
                </div>

                <div class="stats-block">
                    <p class="stats-text">КД:</p>
                    <span id="stats-kd" class="stats-result">
                        <?php echo htmlspecialchars($user->getStats()->getKd()) ?>
                    </span>
                </div>
